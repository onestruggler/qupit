...
module N.Ex-Sym4n2 (p-2 : ℕ) (p-prime : Prime (2+ p-2)) (n : ℕ)  where
...
aux-hh|hh-ex = begin
  (H • H ↑ • CZ⁻¹ • H • H ↑) • Ex ≈⟨ special-assoc (□ ^ 5 • □) (□ ^ 4 • □ ^ 2) auto ⟩
  (H • H ↑ • CZ⁻¹ • H) • H ↑ • Ex ≈⟨ cright lemma-comm-Ex-H-n ⟩
  (H • H ↑ • CZ⁻¹ • H) • Ex • H ≈⟨ special-assoc (□ ^ 4 • □ ^ 2) (□ ^ 3 • □ ^ 2 • □) auto ⟩
  (H • H ↑ • CZ⁻¹) • (H • Ex) • H ≈⟨ cright cleft lemma-comm-Ex-H↑ ⟩
  (H • H ↑ • CZ⁻¹) • (Ex • H ↑) • H ≈⟨ special-assoc (□ ^ 3 • □ ^ 2 • □) (□ ^ 2 • □ ^ 2 • □ ^ 2) auto ⟩
  (H • H ↑) • (CZ⁻¹ • Ex) • H ↑ • H ≈⟨ cright cleft word-comm p-1 1 lemma-comm-Ex-CZ-n ⟩
  (H • H ↑) • (Ex • CZ⁻¹) • H ↑ • H ≈⟨ special-assoc (□ ^ 2 • □ ^ 2 • □) (□ • □ ^ 2 • □ ^ 2) auto ⟩
  H • (H ↑ • Ex) • CZ⁻¹ • H ↑ • H ≈⟨ cright cleft lemma-comm-Ex-H-n ⟩
  H • (Ex • H) • CZ⁻¹ • H ↑ • H ≈⟨ special-assoc (□ • □ ^ 2 • □) (□ ^ 2 • □ ^ 2) auto ⟩
...
aux-hEx''' = trans aux-hEx'' (sym (bbc Ex Ex claim))
  ...
  claim = begin
    Ex • (Ex • (H • H ↑ • CZ⁻¹ • H • H ↑)) • Ex ≈⟨ special-assoc (□ • □ ^ 2 • □) (□ ^ 2 • □ ^ 2) auto ⟩
    ...
    (Ex • ( H ↑ • H • CZ⁻¹ • H ↑ • H)) • Ex • Ex ≈⟨ sym (special-assoc (□ • □ ^ 2 • □) (□ ^ 2 • □ ^ 2) auto) ⟩
    Ex • (( H ↑ • H • CZ⁻¹ • H ↑ • H) • Ex) • Ex ≈⟨ cright cleft special-assoc (□ ^ 5 • □) (□ ^ 6 ) auto ⟩
    Ex • (H ↑ • H • CZ⁻¹ • H ↑ • H • Ex) • Ex ∎
