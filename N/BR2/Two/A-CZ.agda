...
module N.BR2.Two.A-CZ (p-2 : ℕ) (p-prime : Prime (2+ p-2)) where
...
lemma-A-CZ-2 a*@(a , nza) b = begin
  ...
  (ZM a* • H • CZ • H ^ 3) • (Ex • CX • [ (a , b) , nz ]ᵃ ↑) • ⟦ (- a , (-' a*) .proj₂) ⁻¹ ⟧ₘ ≈⟨ cright cong (sym (aux-bbox-nza a b nza)) (sym (aux-abox-nzb (- a) ((-' a*) .proj₂))) ⟩
