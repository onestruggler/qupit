...
module N.Proofs.P2 (p-2 : ℕ) (p-prime : Prime (2+ p-2))  where
...
aux-|-nf1 :
  ...
  CZ • ⟦ (s , m , HS^ k) ⟧₁ ↑ ≈ (S^ s • M m • HH) ↑ • CZ^ -m⁻¹ • H ↑ ^ 3 • S^ k ↑
aux-|-nf1 s m k  = begin
  CZ • ⟦ (s , m , HS^ k) ⟧₁ ↑ ≈⟨ refl ⟩
  CZ • (S^ s • M m • H • S^ k) ↑ ≈⟨ sym assoc ⟩
  (CZ • S^ s ↑) • (M m • H • S^ k) ↑ ≈⟨ cleft aux-comm-CZ^a-S^b↑ ₁ s ⟩
  (S^ s ↑ • CZ) • (M m • H • S^ k) ↑ ≈⟨ special-assoc (□ ^ 2 • □ ^ 2) (□ • □ ^ 2 • □) auto ⟩
  S^ s ↑ • (CZ • M m ↑) • (H • S^ k) ↑ ≈⟨ cright cleft lemma-CZ^kM↑ (m .proj₁) ₁ (m .proj₂) ⟩
  S^ s ↑ • (M m ↑ • CZ^ (₁ * m⁻¹)) • (H • S^ k) ↑ ≈⟨ cright cleft cright refl' (Eq.cong CZ^ (*-identityˡ m⁻¹)) ⟩
  S^ s ↑ • (M m ↑ • CZ^ m⁻¹) • (H • S^ k) ↑ ≈⟨ cright cleft cright trans (sym left-unit) (sym (cong (axiom (cong↑ order-H)) refl)) ⟩
  S^ s ↑ • (M m ↑ • H ↑ ^ 4 • CZ^ m⁻¹) • (H • S^ k) ↑ ≈⟨ special-assoc (□ • (□ • □ ^ 4 • □) • □) (□ ^ 4 • (□ ^ 2 • □) • □) auto ⟩
  (S^ s ↑ • M m ↑ • HH ↑) • (HH ↑ • CZ^ m⁻¹) • (H • S^ k) ↑ ≈⟨ cright cleft lemma-semi-HH↑-CZ^k m⁻¹ ⟩
  (S^ s ↑ • M m ↑ • HH ↑) • (CZ^ -m⁻¹ • HH ↑) • (H • S^ k) ↑ ≈⟨ special-assoc (□ • □ ^ 3 • □ ^ 2) (□ • □ • □ ^ 3 • □) auto ⟩
  (S^ s • M m • HH) ↑ • CZ^ -m⁻¹ • H ↑ ^ 3 • S^ k ↑  ∎
  where
  m⁻¹ = (m ⁻¹) .proj₁
  -m⁻¹ = - m⁻¹
...
aux-|-nf1-pf :
  ...
  -m⁻¹ = - m⁻¹
  in
  CZ • ⟦ (s , m , HS^ k) ⟧₁ ↑ • ⟦ pf ⟧ₚ ≈ (S^ s • M m • HH) ↑ • ⟦ case-|| (-' m ⁻¹) k pf ⟧₂
aux-|-nf1-pf s m k pf = begin
  CZ • ⟦ (s , m , HS^ k) ⟧₁ ↑ • ⟦ pf ⟧ₚ ≈⟨ sym assoc ⟩
  (CZ • ⟦ (s , m , HS^ k) ⟧₁ ↑) • ⟦ pf ⟧ₚ ≈⟨ cleft aux-|-nf1 s m k ⟩
  ((S^ s • M m • HH) ↑ • CZ^ -m⁻¹ • H ↑ ^ 3 • S^ k ↑) • ⟦ pf ⟧ₚ ≈⟨ special-assoc (□ ^ 4 • □) (□ • □ ^ 4) auto ⟩
  (S^ s • M m • HH) ↑ • CZ^ -m⁻¹ • H ↑ ^ 3 • S^ k ↑ • ⟦ pf ⟧ₚ ≈⟨ refl ⟩
  (S^ s • M m • HH) ↑ • ⟦ case-|| (-' m ⁻¹) k pf ⟧₂ ∎
  where
  m⁻¹ = (m ⁻¹) .proj₁
  -m⁻¹ = - m⁻¹
...
aux-NF2''' : ∀ k* l (pf : Postfix) -> (nz : l ≢ ₀) -> (k≠1 : k* .proj₁ ≢ ₁) ->
  ∃ \ w -> ∃ \ nf2 -> ⟦ case-|| k* l pf ⟧₂ ≈ w ↑ • ⟦ nf2 ⟧₂ • Ex 
aux-NF2''' k*@(k , nzk) l pf@(sp , mc2 , mc1) nz k≠1 = (M (l* ⁻¹) • S^ -l • S^ kl • H • S^ ss • M mm • HH) ,  case-|| (mm ⁻¹)  kk (sp' , mc1 , mc2) , (begin
  ⟦ case-|| k* l pf ⟧₂ ≈⟨ refl ⟩
  ...
  (S^ sp • HH) • M (l* ⁻¹) ↑ • S^ -l ↑ • S^ kl • S^ kl ↑ • H ↑ • CZ • (H ^ 3 • S^ -kl • H • S^ -l⁻¹ • H) ↑ • H • CZ • H • (⟦ mc2 ⟧ₘ₊ • ⟦ mc1 ⟧ₘ₊ ↑) • Ex ≈⟨ cright cright cright cright cright cright cright cleft  ( cright cleft refl' (Eq.cong (\ xx -> S^ xx ↑) aux-kl=kl')) ⟩
  (S^ sp • HH) • M (l* ⁻¹) ↑ • S^ -l ↑ • S^ kl • S^ kl ↑ • H ↑ • CZ • (H ^ 3 • S^ -kl' • H • S^ -l⁻¹ • H) ↑ • H • CZ • H • (⟦ mc2 ⟧ₘ₊ • ⟦ mc1 ⟧ₘ₊ ↑) • Ex ≈⟨ cright cright cright cright cright cright cright cleft  lemma-cong↑  _ _ (smc  .proj₂ .proj₂ .proj₂ ) ⟩
  (S^ sp • HH) • M (l* ⁻¹) ↑ • S^ -l ↑ • S^ kl • S^ kl ↑ • H ↑ • CZ • ⟦ ss , mm , HS^ kk ⟧₁ ↑ • H • CZ • H • (⟦ mc2 ⟧ₘ₊ • ⟦ mc1 ⟧ₘ₊ ↑) • Ex ≈⟨ special-assoc (□ • □ • □ • □ • □ • □ • □ • □ ^ 2 • □ ) (□ ^ 6 • □ ^ 2 • □ ^ 2) auto ⟩
  ((S^ sp • HH) • M (l* ⁻¹) ↑ • S^ -l ↑ • S^ kl • S^ kl ↑ • H ↑) • (CZ • S^ ss ↑) • ⟦ mm , HS^ kk ⟧ₘ₊ ↑ • H • CZ • H • (⟦ mc2 ⟧ₘ₊ • ⟦ mc1 ⟧ₘ₊ ↑) • Ex ≈⟨ cong aux9 (cleft aux-comm-CZ^a-S^b↑ ₁ ss) ⟩
  ((M (l* ⁻¹) ↑ • S^ -l ↑ • S^ kl ↑ • H ↑) • (S^ sp' • HH)) • (S^ ss ↑ • CZ) • ⟦ mm , HS^ kk ⟧ₘ₊ ↑ • H • CZ • H • (⟦ mc2 ⟧ₘ₊ • ⟦ mc1 ⟧ₘ₊ ↑) • Ex ≈⟨ cright special-assoc (□ ^ 2 • □ ^ 2 • □) (□ • □ ^ 2 • □ ^ 2) auto ⟩
  ((M (l* ⁻¹) ↑ • S^ -l ↑ • S^ kl ↑ • H ↑) • (S^ sp' • HH)) • S^ ss ↑ • (CZ • M mm ↑) • (H • S^ kk) ↑ • H • CZ • H • (⟦ mc2 ⟧ₘ₊ • ⟦ mc1 ⟧ₘ₊ ↑) • Ex ≈⟨ cright cright cleft lemma-CZM↑ (mm .proj₁) (mm .proj₂) ⟩
  ((M (l* ⁻¹) ↑ • S^ -l ↑ • S^ kl ↑ • H ↑) • (S^ sp' • HH)) • S^ ss ↑ • (M mm ↑ • CZ^ mm⁻¹) • (H • S^ kk) ↑ • H • CZ • H • (⟦ mc2 ⟧ₘ₊ • ⟦ mc1 ⟧ₘ₊ ↑) • Ex ≈⟨ special-assoc (□ ^ 2 • □ • □ ^ 2 • □) (□ • (□ ^ 3) • □ ^ 2) auto ⟩
  (M (l* ⁻¹) ↑ • S^ -l ↑ • S^ kl ↑ • H ↑) • ((S^ sp' • HH) • S^ ss ↑ • M mm ↑) • CZ^ mm⁻¹ • (H • S^ kk) ↑ • H • CZ • H • (⟦ mc2 ⟧ₘ₊ • ⟦ mc1 ⟧ₘ₊ ↑) • Ex ≈⟨ cright cleft lemma-comm-S^aH^b sp' ₂ (S^ ss • M mm) ⟩
  (M (l* ⁻¹) ↑ • S^ -l ↑ • S^ kl ↑ • H ↑) • ((S^ ss ↑ • M mm ↑) • (S^ sp' • HH)) • CZ^ mm⁻¹ • (H • S^ kk) ↑ • H • CZ • H • (⟦ mc2 ⟧ₘ₊ • ⟦ mc1 ⟧ₘ₊ ↑) • Ex ≈⟨ cright special-assoc (□ ^ 3 • □ ^ 2) (□ • □ • □ ^ 2 • □) auto ⟩
  (M (l* ⁻¹) ↑ • S^ -l ↑ • S^ kl ↑ • H ↑) • (S^ ss ↑ • M mm ↑) • S^ sp' • (HH • CZ^ mm⁻¹) • (H • S^ kk) ↑ • H • CZ • H • (⟦ mc2 ⟧ₘ₊ • ⟦ mc1 ⟧ₘ₊ ↑) • Ex ≈⟨ cright cright cright (cleft lemma-semi-HH↓-CZ^k' mm⁻¹) ⟩
  (M (l* ⁻¹) ↑ • S^ -l ↑ • S^ kl ↑ • H ↑) • (S^ ss ↑ • M mm ↑) • S^ sp' • (CZ^ (- mm⁻¹) • HH) • (H • S^ kk) ↑ • H • CZ • H • (⟦ mc2 ⟧ₘ₊ • ⟦ mc1 ⟧ₘ₊ ↑) • Ex ≈⟨ cright cright special-assoc (□ • □ ^ 2 • □ ^ 2) (□ ^ 2 • □ ^ 2 • □) auto ⟩
  (M (l* ⁻¹) ↑ • S^ -l ↑ • S^ kl ↑ • H ↑) • (S^ ss ↑ • M mm ↑) • (S^ sp' • CZ^ (- mm⁻¹)) • (HH • (H • S^ kk) ↑) • H • CZ • H • (⟦ mc2 ⟧ₘ₊ • ⟦ mc1 ⟧ₘ₊ ↑) • Ex ≈⟨ cright cright cong (word-comm (toℕ sp') (toℕ (- mm⁻¹)) (sym (axiom comm-CZ-S↓))) (cleft lemma-comm-Hᵏ-w↑ 2 (H • S^ kk)) ⟩
  (M (l* ⁻¹) ↑ • S^ -l ↑ • S^ kl ↑ • H ↑) • (S^ ss ↑ • M mm ↑) • (CZ^ (- mm⁻¹) • S^ sp') • ((H • S^ kk) ↑ • HH) • H • CZ • H • (⟦ mc2 ⟧ₘ₊ • ⟦ mc1 ⟧ₘ₊ ↑) • Ex ≈⟨ cright cright special-assoc (□ ^ 2 • □ ^ 3 • □ • □) (□ • □ ^ 2 • □ ^ 3 • □) auto ⟩
  (M (l* ⁻¹) ↑ • S^ -l ↑ • S^ kl ↑ • H ↑) • (S^ ss ↑ • M mm ↑) • CZ^ (- mm⁻¹) • (S^ sp' • (H • S^ kk) ↑) • H ^ 3 • CZ • H • (⟦ mc2 ⟧ₘ₊ • ⟦ mc1 ⟧ₘ₊ ↑) • Ex ≈⟨ cright cright cright cleft lemma-comm-Sᵏ-w↑ (toℕ sp') (H • S^ kk) ⟩
  (M (l* ⁻¹) ↑ • S^ -l ↑ • S^ kl ↑ • H ↑) • (S^ ss ↑ • M mm ↑) • CZ^ (- mm⁻¹) • ((H • S^ kk) ↑ • S^ sp') • H ^ 3 • CZ • H • (⟦ mc2 ⟧ₘ₊ • ⟦ mc1 ⟧ₘ₊ ↑) • Ex ≈⟨ cright cright cright assoc ⟩
  (M (l* ⁻¹) ↑ • S^ -l ↑ • S^ kl ↑ • H ↑) • (S^ ss ↑ • M mm ↑) • CZ^ (- mm⁻¹) • (H • S^ kk) ↑ • S^ sp' • H ^ 3 • CZ • H • (⟦ mc2 ⟧ₘ₊ • ⟦ mc1 ⟧ₘ₊ ↑) • Ex ≈⟨ cright cright trans (sym left-unit) (cleft sym (axiom (cong↑ order-H))) ⟩
  (M (l* ⁻¹) ↑ • S^ -l ↑ • S^ kl ↑ • H ↑) • (S^ ss ↑ • M mm ↑) • H ↑ ^ 4 • CZ^ (- mm⁻¹) • (H • S^ kk) ↑ • S^ sp' • H ^ 3 • CZ • H • (⟦ mc2 ⟧ₘ₊ • ⟦ mc1 ⟧ₘ₊ ↑) • Ex ≈⟨ cright cright special-assoc (□ ^ 4 • □ ^ 2) (□ ^ 2 • (□ ^ 2 • □) • □) auto ⟩
  (M (l* ⁻¹) ↑ • S^ -l ↑ • S^ kl ↑ • H ↑) • (S^ ss ↑ • M mm ↑) • HH ↑ • (HH ↑ • CZ^ (- mm⁻¹)) • (H • S^ kk) ↑ • S^ sp' • H ^ 3 • CZ • H • (⟦ mc2 ⟧ₘ₊ • ⟦ mc1 ⟧ₘ₊ ↑) • Ex ≈⟨ cright cright cright cleft sym (lemma-semi-CZ^k-HH↑ mm⁻¹) ⟩
  (M (l* ⁻¹) ↑ • S^ -l ↑ • S^ kl ↑ • H ↑) • (S^ ss ↑ • M mm ↑) • HH ↑ • (CZ^ (mm⁻¹) • HH ↑) • (H • S^ kk) ↑ • S^ sp' • H ^ 3 • CZ • H • (⟦ mc2 ⟧ₘ₊ • ⟦ mc1 ⟧ₘ₊ ↑) • Ex ≈⟨ cright cright cright special-assoc (□ ^ 3 • □ ^ 2 • □) (□ • □ ^ 3 • □ ^ 2) auto ⟩
  (M (l* ⁻¹) ↑ • S^ -l ↑ • S^ kl ↑ • H ↑) • (S^ ss ↑ • M mm ↑) • HH ↑ • CZ^ (mm⁻¹) • H ↑ ^ 3 • S^ kk ↑ • S^ sp' • H ^ 3 • CZ • H • (⟦ mc2 ⟧ₘ₊ • ⟦ mc1 ⟧ₘ₊ ↑) • Ex ≈⟨  cright cright cright cright cright cright cright cright cright cright cleft aux-comm-MCMC (mc2 .proj₁) (mc2 .proj₂) (mc1 .proj₁) (mc1 .proj₂) ⟩
  (M (l* ⁻¹) ↑ • S^ -l ↑ • S^ kl ↑ • H ↑) • (S^ ss ↑ • M mm ↑) • HH ↑ • CZ^ (mm⁻¹) • H ↑ ^ 3 • S^ kk ↑ • S^ sp' • H ^ 3 • CZ • H • (⟦ mc1 ⟧ₘ₊ ↑ • ⟦ mc2 ⟧ₘ₊) • Ex ≈⟨ special-assoc (□ ^ 4 • □ ^ 2 • □ ^ 10) (□ ^ 7 • (□ • □ • □ • □ • □ ^ 3 • □) • □) auto ⟩
  (M (l* ⁻¹) • S^ -l • S^ kl • H • S^ ss • M mm • HH) ↑ • (CZ^ (mm⁻¹) • H ↑ ^ 3 • S^ kk ↑ • S^ sp' • (H ^ 3 • CZ • H) • (⟦ mc1 ⟧ₘ₊ ↑ • ⟦ mc2 ⟧ₘ₊)) • Ex ≈⟨ refl ⟩
  (M (l* ⁻¹) • S^ -l • S^ kl • H • S^ ss • M mm • HH) ↑ • ⟦ case-|| (mm ⁻¹)  kk (sp' , mc1 , mc2) ⟧₂ • Ex  ∎)
  where
  1⁻¹ : ℤ ₚ
  1⁻¹ = (((₁ , λ ()) ⁻¹)) .proj₁
  ...
  aux9 : ((S^ sp • HH) • M (l* ⁻¹) ↑ • S^ -l ↑ • S^ kl • S^ kl ↑ • H ↑) ≈ ((M (l* ⁻¹) ↑ • S^ -l ↑ • S^ kl ↑ • H ↑) • (S^ sp' • HH))
  aux9 = begin
    ((S^ sp • HH) • M (l* ⁻¹) ↑ • S^ -l ↑ • S^ kl • S^ kl ↑ • H ↑) ≈⟨ special-assoc (□ ^ 6) (□ ^ 3 • □ ^ 3) auto ⟩
    ((S^ sp • HH) • M (l* ⁻¹) ↑ • S^ -l ↑) • S^ kl • S^ kl ↑ • H ↑ ≈⟨ cleft lemma-comm-S^aH^b sp ₂ (M (l* ⁻¹) • S^ -l) ⟩
    ((M (l* ⁻¹) ↑ • S^ -l ↑) • (S^ sp • HH)) • S^ kl • S^ kl ↑ • H ↑ ≈⟨ special-assoc (□ ^ 3 • □ ^ 3) (□ • □ • □ ^ 2 • □ ^ 2) auto ⟩
    (M (l* ⁻¹) ↑ • S^ -l ↑) • S^ sp • (HH • S^ kl) • S^ kl ↑ • H ↑ ≈⟨ cright cright cleft word-comm 1 (toℕ kl) (trans assoc (axiom comm-HHS)) ⟩
    (M (l* ⁻¹) ↑ • S^ -l ↑) • S^ sp • (S^ kl • HH) • S^ kl ↑ • H ↑ ≈⟨ cright special-assoc (□ • □ ^ 2 • □) (□ ^ 2 • □ ^ 2) auto ⟩
    (M (l* ⁻¹) ↑ • S^ -l ↑) • (S^ sp • S^ kl) • HH • S^ kl ↑ • H ↑ ≈⟨ cright cleft lemma-S^k+l sp kl ⟩
    (M (l* ⁻¹) ↑ • S^ -l ↑) • S^ (sp + kl) • HH • S^ kl ↑ • H ↑ ≈⟨ cright sym assoc ⟩
    (M (l* ⁻¹) ↑ • S^ -l ↑) • (S^ (sp + kl) • HH) • S^ kl ↑ • H ↑ ≈⟨ cright lemma-comm-S^aH^b (sp + kl) ₂ (S^ kl • H) ⟩
    (M (l* ⁻¹) ↑ • S^ -l ↑) • (S^ kl ↑ • H ↑) • (S^ (sp + kl) • HH) ≈⟨ special-assoc (□ ^ 2 • □ ^ 2 • □) (□ ^ 4 • □ ) auto ⟩
    ((M (l* ⁻¹) ↑ • S^ -l ↑ • S^ kl ↑ • H ↑) • (S^ sp' • HH)) ∎
{-
...
-- aux-|| k* l* sp pf eq = begin
--   ⟦ case-|| k* sp pf ⟧₂ ≈⟨ {!!} ⟩
--   ⟦ case-|| l*  sp pf ⟧₂ ∎



aux-NF2-Ex : ∀ k* l (pf : Postfix) -> (k≠1 : k* .proj₁ ≢ ₁) ->

  ∃ \ w -> ∃ \ nf2 -> ⟦ case-|| k* l pf ⟧₂ ≈ w ↑ • ⟦ nf2 ⟧₂ • Ex 

aux-NF2-Ex k* l@₀ pf@(sp , mc2 , mc1) k≠1 = HH , nf2 , aux2
  where
  kp = prede k*
  aux : - kp ≢ ₀
...
aux-NF2-Ex k* l@(₁₊ l') pf k≠1 = aux-NF2''' k* l pf (λ ()) k≠1
  where
