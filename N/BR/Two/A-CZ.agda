...
lemma-A-CZ-2 a*@(a , nza) b = begin
  ...
  (ZM a* • H • CZ • H ^ 3) • (Ex • CX • [ (a , b) , nz ]ᵃ ↑) • ⟦ (- a , (-' a*) .proj₂) ⁻¹ ⟧ₘ ≈⟨ cleft special-assoc (□ ^ 4) (□ ^ 2 • □ ^ 2) auto ⟩
  ((ZM a* • H) • CZ • H ^ 3) • (Ex • CX • [ (a , b) , nz ]ᵃ ↑) • ⟦ (- a , (-' a*) .proj₂) ⁻¹ ⟧ₘ ≈⟨ cleft (cleft sym (semi-HM' a*)) ⟩
  ((H • ZM (a* ⁻¹)) • CZ • H ^ 3) • (Ex • CX • [ (a , b) , nz ]ᵃ ↑) • ⟦ (- a , (-' a*) .proj₂) ⁻¹ ⟧ₘ ≈⟨ cleft sym (special-assoc (□ • □ ^ 2 • □) (□ ^ 2 • □ ^ 2) auto) ⟩
  (H • (ZM (a* ⁻¹) • CZ )• H ^ 3) • (Ex • CX • [ (a , b) , nz ]ᵃ ↑) • ⟦ (- a , (-' a*) .proj₂) ⁻¹ ⟧ₘ ≈⟨ cleft (cright cleft axiom (semi-M↓CZ (a* ⁻¹))) ⟩
  (H • (CZ^ a⁻¹ • ZM (a* ⁻¹) )• H ^ 3) • (Ex • CX • [ (a , b) , nz ]ᵃ ↑) • ⟦ (- a , (-' a*) .proj₂) ⁻¹ ⟧ₘ ≈⟨ cleft special-assoc (□ • □ ^ 2 • □) (□ ^ 2 • □ ^ 2) auto ⟩
  ((H • CZ^ a⁻¹) • ZM (a* ⁻¹) • H ^ 3) • (Ex • CX • [ (a , b) , nz ]ᵃ ↑) • ⟦ (- a , (-' a*) .proj₂) ⁻¹ ⟧ₘ ≈⟨ cleft (cright sym (L01.aux-H³M (a , nza))) ⟩
  ((H • CZ^ a⁻¹) • H ^ 3 • ZM a*) • (Ex • CX • [ (a , b) , nz ]ᵃ ↑) • ⟦ (- a , (-' a*) .proj₂) ⁻¹ ⟧ₘ ≈⟨  special-assoc (□ ^ 3 • □ ^ 3 • □) (□ ^ 2 • □ ^ 2 • □ ^ 3) auto ⟩
  ((H • CZ^ a⁻¹) • H ^ 3) • (ZM a* • Ex) • CX • [ (a , b) , nz ]ᵃ ↑ • ⟦ (- a , (-' a*) .proj₂) ⁻¹ ⟧ₘ ≈⟨  cright cleft sym (lemma-Ex-M' a*) ⟩
  ((H • CZ^ a⁻¹) • H ^ 3) • (Ex • ZM a* ↑) • CX • [ (a , b) , nz ]ᵃ ↑ • ⟦ (- a , (-' a*) .proj₂) ⁻¹ ⟧ₘ ≈⟨  cright special-assoc (□ ^ 2 • □ ^ 2) (□ • □ ^ 2 • □) auto ⟩
  ...
  ((H • CZ^ a⁻¹) • H ^ 3) • Ex • (CX'^ a • ZM a* ↑) • (⟦ a* ⁻¹ ⟧ₘ ↑ • H ↑ • S^ -b/a ↑) • ⟦ (- a , (-' a*) .proj₂) ⁻¹ ⟧ₘ ≈⟨  cright cright special-assoc (□ ^ 2 • □ ^ 3 • □) (□ • □ ^ 2 • □ ^ 3) auto ⟩
  ...
  ((H • CZ^ a⁻¹) • H ^ 3) • Ex • CX'^ a • H ↑ • S^ -b/a ↑ • ⟦ (- a , (-' a*) .proj₂) ⁻¹ ⟧ₘ ≈⟨ cong assoc (special-assoc (□ ^ 5) (□ ^ 4 • □) auto) ⟩
